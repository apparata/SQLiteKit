...
@resultBuilder
public struct SQLQueryStringBuilder {
    ...
    public static func buildFinalResult(_ component: [String]) -> SQLQueryString {
        return component.joined(separator: " ")
    }

    public static func buildFinalResult(_ component: [String]) -> SQLQuery {
        return SQLQuery(component.joined(separator: " "))
    }
}
